SIM_NAME="network_info/24h_sim-test"
LOCAL_DATA_FILE_PATH="/Users/yme/Code/York/sumo_ingolstadt_marl/data"
LOCAL_SIMULATION_FILE_PATH="/Users/yme/Code/York/sumo_ingolstadt_marl/simulation/"
IMAGE_NAME="yassinmelsir/simulation-marl-ni:latest"

CONTAINER_CONFIG_FILE_PATH="/usr/app/simulation/24h_sim_10s.sumocfg"
...
RUN_SCRIPT="python3 /usr/app/src/network_info/main.py \
                      --sumo_cmd \"${SUMO_CMD}\" \
